                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-table">
                                ...
                                <tbody>
                                  ...
                                  <tr class="<?php echo $rowClass;?> gradeX">
                                      ...
                                      <td><span class="moreinfo" title="string actually stored in database: <?php echo $row['email'];?>"><?php echo $dao->dec($row['email']);?></span></td>
                                      <td><span class="moreinfo" title="string actually stored in database: <?php echo $row['email'];?>"><?php echo $dao->dec($row['phone']);?></span></td>
